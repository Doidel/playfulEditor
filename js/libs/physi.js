window.Physijs = (function() {
	...
	Physijs.createMaterial = function( material, friction, restitution ) {
		...
		physijs_material.prototype.baseClone = material.clone; //hack to keep the original clone
		physijs_material.prototype.clone = function() {
			
			var mat = Physijs.createMaterial(
				this.baseClone(),
				this._physijs.friction,
				this._physijs.restitution
			);
			//mat._physijs.massmodifier = this._physijs.massmodifier;
			return mat;
		};
	...
	Physijs.Scene.prototype.resetSimulation = function() {
		this.execute( 'resetSimulation' );
	};
	...
	Physijs.Mesh.prototype._cloneEvents = function ( object, clone ) {
				
		for (var k in object) {
			if (object.hasOwnProperty( k )) {
				
				if ( object[ k ] instanceof Blob ) {
				
					clone[ k ] = object[ k ];
				
				} else if ( typeof object[ k ] == 'object' ) {
					clone[ k ] = Array.isArray( object[ k ] ) ? [] : {};
					this._cloneEvents( object[ k ], clone[ k ] );
				} else {
					clone[ k ] = object[ k ];
				}
	...
	Physijs.Mesh.prototype.clone = function( object, recursive ) {
		...
		if ( this.events ) {
			...
			object.events = [];
			this._cloneEvents( this.events, object.events );
			
		}
		
		THREE.Object3D.prototype.clone.call( this, object, recursive );
		
		object.isStatic = this.isStatic;
		
		if ( this.geometry && this.geometry.parameters ) {
			object.geometry.parameters = {};
			for ( var key in this.geometry.parameters ) {
				if ( this.geometry.parameters.hasOwnProperty( key ) ) {
					object.geometry.parameters[ key ] = this.geometry.parameters[ key ];
				}
			}
		}
	...
	Physijs.PlaneMesh.prototype.clone = function( object, recursive ) {
		
		if ( object === undefined ) {
			object = new Physijs.PlaneMesh( this.geometry, this.material , this._physijs.mass );
		}
		
		Physijs.Mesh.prototype.clone.call( this, object, recursive );
	...
	Physijs.BoxMesh.prototype.clone = function( object, recursive ) {
		
		if ( object === undefined ) {
			object = new Physijs.BoxMesh( this.geometry.clone(), this.material , this._physijs.mass );
		}
	...
	Physijs.BoxMesh.prototype.scaleBy = function( scale, oldParams ) {
	
		this.geometry.dispose();

		this.geometry = new THREE.BoxGeometry(
			oldParams.width * scale.x,
			oldParams.height * scale.y,
			oldParams.depth * scale.z,
			1,
			1,
			1
		);
	...
	Physijs.SphereMesh.prototype.clone = function( object, recursive ) {
		
		if ( object === undefined ) {
			object = new Physijs.SphereMesh( this.geometry.clone(), this.material, this._physijs.mass )
		}
	...
	Physijs.SphereMesh.prototype.scaleBy = function( scale, oldParams ) {
	
		this.geometry.dispose();

		this.geometry = new THREE.SphereGeometry(
			oldParams.radius * scale.y,
			oldParams.widthSegments,
			oldParams.heightSegments
		);
	...
	Physijs.CylinderMesh.prototype.clone = function( object, recursive ) {
		
		if ( object === undefined ) {
			object = new Physijs.CylinderMesh( this.geometry.clone(), this.material , this._physijs.mass );
		}
	...
	Physijs.CylinderMesh.prototype.scaleBy = function( scale, oldParams ) {
	
		this.geometry.dispose();

		this.geometry = new THREE.CylinderGeometry(
			oldParams.radiusTop * scale.y,
			oldParams.radiusBottom * scale.y,
			oldParams.height * scale.y,
			oldParams.radiusSegments,
			oldParams.heightSegments,
			oldParams.openEnded
		);
	...
	Physijs.CapsuleMesh.prototype.clone = function( object, recursive ) {
		
		if ( object === undefined ) {
			object = new Physijs.CapsuleMesh( this.geometry.clone(), this.material , this._physijs.mass );
		}
	...
	Physijs.ConeMesh.prototype.clone = function( object, recursive ) {
		
		if ( object === undefined ) {
			object = new Physijs.ConeMesh( this.geometry, this.material , this._physijs.mass );
		}
	...
	Physijs.ConcaveMesh.prototype.clone = function( object, recursive ) {
		
		if ( object === undefined ) {
			object = new Physijs.ConcaveMesh( this.geometry, this.material , this._physijs.mass );
		}
	...
	Physijs.ConvexMesh.prototype.clone = function( object, recursive ) {
		
		if ( object === undefined ) {
			object = new Physijs.ConvexMesh( this.geometry, this.material , this._physijs.mass );
		}
