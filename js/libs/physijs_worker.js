...
public_functions.setRestitution = function( description ) {

	var body = _objects[ description.id ];
	console.log( body.getRestitution() );
	
	// Per http://www.bulletphysics.org/Bullet/phpBB3/viewtopic.php?p=&f=9&t=3663#p13816
	world.removeRigidBody( body );
	
	body.setRestitution( description.val );
...
public_functions.resetSimulation = function resetSimulation() {
	last_simulation_time = Date.now();
};
